...
<section className="page" id="page-about">
  <div className="wrap">
    <div className="page-head">
      ...
      <h1><span className="chroma" data-text="Who we are">Who we are</span></h1>
      <p>A student-run technical club at Symbiosis Institute of Technology, Pune, dedicated to immersive technologies and interactive media.</p>
    </div>
    <div className="about-grid">
      ...
      <div>
        <div className="vision-box">
          <h3>Mission</h3>
          <p>To give every SIT student the skills, hardware access, and team experience needed to ship real interactive and immersive products before they graduate.</p>
        </div>
        <div className="vision-box">
          <h3>Vision</h3>
          <p>To make SIT Pune a recognised student hub for XR and game development in India — a campus where the next generation of spatial computing is prototyped.</p>
        </div>
        <div className="vision-box">
          <h3>Values</h3>
